...
class PanelAyuda():
    ...
    def __init__(self):
        ...
        self._labelTxt = tkinter.Label(panel, text="Hola!."+ '\n'+ "A continuacion encontraras los comandos de teclado"+ '\n' + "para jugar. Recuerdalos para tener una partida increible!", font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=30)
        
             
        self._labelCom1 = tkinter.Label(panel, text="Avanzar hacia adelante" , font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=120)
        self._labelCom2 = tkinter.Label(panel, text="Avanzar hacia atras" , font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=170)
        self._labelCom3 = tkinter.Label(panel, text="Avanzar hacia la arriba" , font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=220)
        self._labelCom4 = tkinter.Label(panel, text="Avanzar hacia abajo" , font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=270)      
        self._labelCom5 = tkinter.Label(panel, text="Patear Balon" , font=("Agency FB",12), bg = 'white', pady = 0).place(x=80, y=320)      
        ...
        self._imageLabelDerecha = tkinter.Label(panel, image= self._imageFlechaDerecha).place(x= 300, y = 120)
        self._imageLabelIzquierda= tkinter.Label(panel, image= self._imageFlechaIzquierda).place(x= 300, y = 170)
        self._imageLabelArriba = tkinter.Label(panel, image= self._imageFlechaArriba).place(x= 300, y = 220)
        self._imageLabelAbajo = tkinter.Label(panel, image= self._imageFlechaAbajo).place(x= 300, y = 270)
        self._imageLabelPatear = tkinter.Label(panel, image= self._imagePatear).place(x= 300, y = 320)        
        
        self._btnVolver = tkinter.Button(panel,text="Volver atras", font= ("Agency FB",10), width = 20).place(x= 150, y = 500) 
        
        self._labelCreditos = tkinter.Label(panel, text="Creditos:" , font=("Agency FB",8), bg = 'white', pady = 0).place(x=170, y=530) 
        self._labelCom4 = tkinter.Label(panel, text="Jorge Lievano-Kliver Giron"+ '\n' + "Sergio lozada - Cristian Cobo"+ '\n'+ "2019 " , font=("Agency FB",6), bg = 'white', pady = 0).place(x=150, y=550) 
